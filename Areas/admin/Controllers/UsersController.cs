...
namespace eshop.Areas.Admin.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public UsersController(EshopDBContext context, ILoggerFactory logger)
        {
            _context = context;
            _logger = logger.CreateLogger(typeof(UsersController));
        }

        // GET: Admin/Users
        public async Task<IActionResult> Index()
        {
            _logger.LogInformation("UsersController > Index() was called.");
        ...
        {
            _logger.LogInformation("UsersController > Details() was called.");
            if (id == null)
            {
                return NotFound();
            }
        ...
        {
            _logger.LogInformation("UsersController > Create() was called.");
            return View();
        }
        ...
        {
            _logger.LogInformation("UsersController > Edit() was called.");
            if (id == null)
            {
                return NotFound();
            }
        ...
        {
            _logger.LogInformation("UsersController > Delete() was called.");
            if (id == null)
            {
                return NotFound();
            }
        ...
        {
            _logger.LogInformation("UsersController > DeleteConfirmed() was called.");
            var user = await _context.Accounts.FindAsync(id);
        ...
        {
            _logger.LogInformation("UsersController > UserExists() was called.");
